...
<p class="title">会員情報登録</p>
<p>${error}</p>
<p>${success}</p>


<section class="page">
	<form action="/MemberInformation/RegistServlet" method="post">
		<p>
		...
		<p>
			■性別<br> <label> <input type="radio" name="sex" value="1"
				checked>男
			</label> <label> <input type="radio" name="sex" value="2">女
			</label>
		</p>
		<p>
